...
//  Test
//
//  Created by 黄沐 on 15/12/21.
//  Copyright © 2015年 黄沐. All rights reserved.
//
...
- (void)viewPrepare{
    ...
    //隐藏各种条
    self.showsHorizontalScrollIndicator = NO; //隐藏水平条
...
{
    GuidePageViewController *newFeatureVC = [[GuidePageViewController alloc] init];
